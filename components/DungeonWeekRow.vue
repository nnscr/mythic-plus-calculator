...
const time = computed(() => playerData.hypotheticalTimes[props.dungeon.short][props.week]);

const hypotheticalScore = computed(() => playerData.hypotheticalScores[props.dungeon.short]);

const originalScore = computed(() => playerData.originalScores[props.dungeon.short]);

const changed = computed(
    () => !hypotheticalScore.value.baseScore[props.week].equals(originalScore.value.baseScore[props.week])
);
</script>
...
<template>
    ...
    >
        ...
        <div class="week-row">
            <div class="week-row--level flex flex-col items-center lg:px-4 xl:px-10 text-center">
                ...
                <div class="flex flex-row-reverse md:flex-col items-center">
                    ...
                    <div class="cursor-pointer md:h-6 w-8" @click="time.level = Math.max(0, time.level - 1)">
                        <div class="hidden md:block">
            ...
            <div class="week-row--base flex flex-col grow tabular-nums">
                ...
                <div class="flex flex-row items-center">
                    ...
                    >
                        <RelativeScore
                            class="ml-1 text-sm"
                            v-if="!hypotheticalScore.baseScore[week].equals(originalScore.baseScore[week])"
            ...
            <div class="week-row--final flex flex-col grow text-white">
                ...
                <div class="flex flex-row items-center">
                    ...
                    >
                        <RelativeScore
                            class="ml-1 text-sm"
                            v-if="!hypotheticalScore.weightedScore[week].equals(originalScore.weightedScore[week])"
